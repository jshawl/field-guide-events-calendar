...
function neoncrm_calendar_register_assets() {
    ...
    wp_register_style(
        ...
        array(),
        filemtime( $plugin_dir . 'assets/css/style.css' )
    );
    ...
    wp_register_script(
        ...
        array( 'jquery' ),
        filemtime( $plugin_dir . 'assets/js/script.js' ),
        true
    );
}
...
add_filter('plugin_action_links_'.plugin_basename(__FILE__), 'neoncrm_calendar_register_settings_link');
...
// Use a capability string and add_options_page for a settings page under Settings
